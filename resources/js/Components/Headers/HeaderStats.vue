    ...
    <div class="flex flex-wrap">
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                ...
                :statPercentColor="total_orders.stateArray === 'up' ? 'text-sky-500' : 'text-red-500'"
        ...
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                ...
                :statPercentColor="total_profit.stateArray === 'up' ? 'text-sky-500' : 'text-red-500'"
                statDescripiron="Since last month"
        ...
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                ...
                :statPercentColor="total_loss.stateArray === 'up' ? 'text-sky-500' : 'text-red-500'"
                statDescripiron="Since last month"
        ...
        <div class="w-full lg:w-6/12 xl:w-3/12 px-4">
            <card-stats
                ...
                :statPercentColor="total_expense.stateArray === 'up' ? 'text-sky-500' : 'text-red-500'"
                statDescripiron="Since last month"
